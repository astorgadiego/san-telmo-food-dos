const CartWidget = () => {
    return (
      <svg className="mt-1 cursor-pointer  space-x-4 h-7  hover:bg-slate-100 " xmlns="http://www.w3.org/2000/svg"  fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
